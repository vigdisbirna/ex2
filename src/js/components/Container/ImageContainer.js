...
export default class ImageContainer extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {image_arr: [], vis_arr: [],  pos_arr: [], interval: null, pos_cnt: 0};
    }
    ...
    loadData() {
        ...
        if(this.state.pos_cnt != 0 /*and neg_cnt*/) {
            var pos_send = [];
            var i = 0;
            ...
            axios({
                method: 'post',
                url: 'http://localhost:5000/learn',
                data: {"pos": pos_send, "neg": [1204751, 652837, 126553, 289004, 1304436, 1267878, 779381, 373122, 344467, 849936, 53155, 1101368, 154084, 1369843, 485161, 272079, 354267, 343382, 453196, 239875, 6151, 911754, 335043, 236151, 1210440, 334363]},
                ...
                'Connection': 'Keep-Alive'
                    ...
                    this.setState({image_arr: res.data, pos_cnt: 0});
                    console.log(res);
