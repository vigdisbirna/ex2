...
export default class ImageContainer extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {image_arr: Array.from(Array(80).keys()), vis_arr: Array.from(Array(25).keys()),  pos_arr: [], neg_arr: [], interval: null, pos_cnt: 0, neg_cnt: 0};
    }
    ...
    initialize() {
        ...
        axios({
            method: 'get',
            url: 'http://192.168.1.101:5000/learn',
            headers: {
