        ...
        return (
            <div className="container sidebar">
                <div className="row sidebar-content"> 
                    ...
                    <div className="col-2 num">{this.state.collection}</div>
                </div>
                <div className="row sidebar-content-top"> 
                    <div className="col-9">Images: </div>
                    <div className="col-2 num">{this.state.images}</div>
                </div>
                <div className="row sidebar-content"> 
                    <div className="col-9">Session Time: </div>
                    <div className="col-2 num">{this.props.timerFromParent}s</div>
                </div>
                <div className="row sidebar-content"> 
                     <div className="col-9">Positive Images: </div>
                     <div className="col-2 num">{this.props.num_posFromParent}</div>
                </div>
                <div className="row sidebar-content"> 
                    <div className="col-9"> Negative Images: </div>
                    <div className="col-2 num">{this.props.num_negFromParent}</div>
                </div>
                <div className="row sidebar-content"> 
                    <div className="col-9">Exploration Rounds: </div>
                    <div className="col-2 num">{this.props.roundsFromParent}</div>
                </div>
                <div className="row sidebar-content">
